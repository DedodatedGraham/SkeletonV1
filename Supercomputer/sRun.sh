...
echo
mpiexec -n 1 -machinefile $PBS_NODEFILE python3 ../Src/Main.py -m 1 -p 128 -i 'infc-0.0000.dat' -o 'infc-0.0000_save.dat'
echo
echo "Skeleton finished at `date`"
mpiexec -n 1 -machinefile $PBS_NODEFILE python3 ../Src/3DSpin.py -i 'Output/infc-0.0000_savePrePurge.dat' -n 30 -m 0
