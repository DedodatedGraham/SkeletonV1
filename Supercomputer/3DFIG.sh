...
#mpiexec -n 1 -machinefile $PBS_NODEFILE python3 ../Src/3DSpin.py -i 'Input/vof_points_norm_0650.dat' -n 30 -m 1
mpiexec -n 1 -machinefile $PBS_NODEFILE python3 ../Src/3DSpin.py -i 'SAVE/BESTSAVE04.dat' -n 30 -m 0
